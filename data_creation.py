...
def generate_data(start_date, end_date, num_points, noise_level):
    ...
    values = [random.uniform(80, 100) for _ in range(num_points)]
...
train_data_params = [
    (datetime(2008, 1, 1), datetime(2009, 12, 31), 730, 10),
    (datetime(2010, 1, 1), datetime(2011, 12, 31), 731, 10),
    (datetime(2012, 1, 1), datetime(2013, 12, 31), 730, 10),
    (datetime(2014, 1, 1), datetime(2015, 12, 31), 731, 10),
    (datetime(2016, 1, 1), datetime(2017, 12, 31), 730, 10)
]

test_data_params = [
    (datetime(2018, 1, 1), datetime(2019, 12, 31), 731, 10),
    (datetime(2020, 1, 1), datetime(2021, 12, 31), 730, 10),
    (datetime(2022, 1, 1), datetime(2023, 12, 31), 731, 10)
]
